...
void main() {
  testWidgets('calculator supports direct area, openings and editable settings', (tester) async {
    await tester.binding.setSurfaceSize(const Size(360, 800));
    addTearDown(() => tester.binding.setSurfaceSize(null));
    await tester.pumpWidget(const MaterialApp(home: MasonryCalculatorScreen(type: MasonryType.clayBrick)));
    ...
    await tester.enterText(find.widgetWithText(TextField, 'Opening width'), '1.2');
    await tester.enterText(find.widgetWithText(TextField, 'Opening height'), '2.1');
    await tester.enterText(find.widgetWithText(TextField, 'Opening quantity'), '2');
    await tester.pumpAndSettle();
