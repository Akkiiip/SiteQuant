        ...
        _Card(
          children: [
            _Tile(
              ...
              title: 'Theme',
              subtitle: 'System',
              onTap: () => _message(context, 'Theme settings coming soon.'),
            ),
            ValueListenableBuilder<MeasurementSystem?>(
              valueListenable: MeasurementPreferences.system,
              builder: (context, system, _) => _Tile(
                icon: Icons.straighten_rounded,
                title: 'Measurement System',
                subtitle:
                    '${(system ?? MeasurementSystem.metric).label}\nYou can change this anytime.',
                onTap: () => showMeasurementSystemDialog(
                  context,
                  initial: system ?? MeasurementSystem.metric,
                ),
              ),
            ),
          ],
