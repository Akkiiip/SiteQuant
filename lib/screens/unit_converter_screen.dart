...
class _UnitConverterScreenState extends State<UnitConverterScreen> {
  ...
  String _formatResult(double value) {
    ...
    if (compact)
      return value.toStringAsExponential(6).replaceFirst(RegExp(r'0+e'), 'e');
      ...
      bodyBuilder: (context, padding) => SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Convert common site units instantly.',
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<UnitDefinition>(
                      ...
                      items: _units
                          ...
                          .toList(),
                      onChanged: (unit) => _selectFrom(unit!),
                    ),
                    Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FittedBox(
                      ...
                      child: Text(
                        result == null ? '—' : _formatResult(result),
                    ...
                    Text(
                      result == null
                          ...
                          : 'From: ${_valueController.text} ${_fromUnit.label}',
                        ...
                        TextButton.icon(
                          onPressed: result == null
                              ...
                              : () => Clipboard.setData(
                                  ClipboardData(
                                    text:
                                        '${_formatResult(result)} ${_toUnit.label}',
                                  ),
                                ),
