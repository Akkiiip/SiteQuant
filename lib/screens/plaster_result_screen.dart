...
class PlasterResultScreen extends StatelessWidget {
  ...
  final double thicknessMm, wastagePercent;
  ...
  String _area(double value) {
    ...
    return '${_number(MeasurementPreferences.fromSquareMetres(value, system), 2)} ${system.areaUnit}';
  }
    ...
    return AppScaffold(
      ...
      bodyBuilder: (context, padding) => ListView(
        ...
        children: [
          ...
          Text(
            'Estimated plaster material quantities.',
              ...
              child: Column(
                ...
                children: [
                  ...
                  _row(
                    context,
                    'Wet Volume',
                    '${_number(result.wetVolume)} m³',
                  ),
                  _row(
                    context,
                    'Dry Volume',
                    '${_number(result.dryVolume)} m³',
                  ),
                  _row(context, 'Cement Bags', _number(result.cementBags, 2)),
                  _row(context, 'Sand', '${_number(result.sandM3)} m³'),
                  _row(context, 'Sand', '${_number(result.sandBrass)} Brass'),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _row(context, 'Area', '${_number(result.area, 2)} m²'),
                  _row(context, 'Thickness', '${_number(thicknessMm, 0)} mm'),
                  _row(context, 'Mortar Ratio', mortarRatio),
                  _row(context, 'Wastage', '${_number(wastagePercent, 1)}%'),
                ],
              ),
            ),
          ),
